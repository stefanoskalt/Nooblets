...
// Stores array of models which are interactable
var modelIsInteractive = [];
...
//example function for loading descriptions
...
function loadModel(toLoadModelArray) {
	...
	myColladaLoader.load(toLoadModelArray['modelPath'], function(collada) {
		...
		// If interactive is set to true, then push the object to the array holding
		// objects which have collision
		if (toLoadModelArray['interactive'] == true) {
			modelIsInteractive.push(toLoadModel);
		}

		console.log(modelIsInteractive);
